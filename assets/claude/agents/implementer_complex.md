---
name: cross-harness-implementer_complex
description: Implement a change that cannot be split into independently verifiable units or that turns on judgment or policy.
...
value, and actual value whenever those facts exist. Do not narrate intermediate work.
